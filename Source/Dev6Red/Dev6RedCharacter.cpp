...
void ADev6RedCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ADev6RedCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADev6RedCharacter::Move);
...
void ADev6RedCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
bool ADev6RedCharacter::GetHasRifle()
{
	return bHasRifle;
}